...
<div class="row">
  ...
  <!-- <marquee class="marque1" behavior="" direction="" > register now   @                                           yakeen the learning institute</marquee> -->
  <div class="col-sm-8" style="  border: 2px solid black;padding:5px; text-align: center; ">
   <h1>Yakeen The Learning Institute Admission Form</h1>
  </div>
  <div class="col-sm-2">
  </div>
  </div>
...
<div class="mb-3 row">
   ...
   <div class="col-sm-4">
     ...
     <div class="col-sm-8">
     <select name="course" required class="form-control" required>
      <option value="">Select Course</option>
        <option value="Basic Computer ">Basic Computer      2500 ₹₹₹ </option>
        <option value="Mathematics">ChatGpt  2500 ₹₹₹</option>
        <option value="PHP Programming">Freelancing  2500 ₹₹₹</option>
     </select>
    </div>
    </div>
    </div>
...
<script>
 ...
 <div id="msg-price"> </div>
  ...
  <div> <a style=" width: 135px; background-color: #1065B7; text-align: center;  font-weight: 900; padding: 11px 0px; color: white; font-size: 20px; display: inline-block; text-decoration: none; border: 5px solid aqua;     border-block: aqua solid 8px; border-radius: 25px; " href='https://pmny.in/hIEj1bPqev1C' > Book Now </a> </div> <br>
  <br>
