  ...
  <div class="col-sm-1">
    ...
    <div class="col-sm-10" style="border: 2px solid black; padding:10px;">
    	<?php 
         ...
         <div class="row">
          <div class="col-2">
            <img src="logo yakeen2.png" class="img-fluid">
          </div>
           <div class="col">
              <div class="main-heading">Yakeen The Learning Institute</div>
     <p class="sub-heading">Eduction center. CIN. No. TS75200CP2921NPL TAN. TCPP90708E</p>
      <div class="address"> 114, megha homes, nintco gali, sahibabad, ghaziabad -   headcourter office: Delhi
</div>
         <p class="email"> Email: info@yakeeninstitute.com , Website: www.naukriindia.online</p>
          </div>
          <div class="col-sm-12">
            <hr class="hrcls"> 
          </div>
